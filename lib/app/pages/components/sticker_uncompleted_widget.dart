...
class StickerUnCompletedWidget extends StatelessWidget {
  StickerUnCompletedWidget({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => _albumStore.toogleStickers(stickerModel.id, true),
      child: Stack(
        children: [
          RotationTransition(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFF861436).withOpacity(.3),
